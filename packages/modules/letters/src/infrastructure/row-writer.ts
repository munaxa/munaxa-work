 ...
 *
 * A near-copy of Compensation's, Leave's, Attendance's, Onboarding's, Recruitment's, Payroll's and
 * Documents' file rather than an import of one: a module may not reach into another module's
 * internals, and hoisting it into `@work/persistence` is a change to a package every phase depends
 * on, recorded as debt rather than made inside a business phase. **This is the eighth copy**, and
 * the debt is restated in the Phase 12 report.
 */
 ...
 * date read on a server west of UTC comes back as the previous day. Every date column here is
 ...
 * `as r.requested_on` is a syntax error, and the one that reads as a mystery.
 */
