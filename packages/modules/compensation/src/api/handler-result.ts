 ...
 * component or the date; it does not name the figure. A rejection's text ends up in logs and error
...
export const unwrapOrThrow = <TValue>(result: Result<TValue, HandlerFailure>): TValue => {
  ...
  switch (result.error.kind) {
    ...
    case 'forbidden':
      ...
      // on "you need compensation.approve"; it reveals nothing about the data.
