 ...
 * and it is the smallest of them — the helpers this module does not need are absent rather than
 * carried across, so nothing here is dead code waiting for a caller.
 */
