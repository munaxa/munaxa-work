...
/**
 * The web app manifest — what an installed Munaxa Work looks like on a home screen.
 *
...
export default function manifest(): MetadataRoute.Manifest {
  return brandManifest('work', 'Employee self-service.') as MetadataRoute.Manifest;
}
