...
/**
 * What the payroll workspace shows while Payroll is being asked.
 *
 * A skeleton rather than a spinner because it holds the layout still. It carries no text at all, so
 * it can carry no placeholder figure — a number on a payroll screen is one somebody might act on,
 * and a fake one is worse than none.
 */
