...
/**
 * What the leave register shows while Leave is being asked.
 *
 * A skeleton rather than a spinner because it holds the layout still. It carries no text at all, so
 * it can carry no placeholder figure — a balance on a leave screen is one somebody plans a holiday
 * against, and a fake one is worse than none.
 */
