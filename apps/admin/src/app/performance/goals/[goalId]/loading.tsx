...
/**
 * What a performance screen shows while Performance is being asked.
 *
 * A skeleton rather than a spinner because it holds the layout still. It carries no text at all, so
 * it can carry no placeholder figure — a score on this screen is one somebody acts on, and a fake
