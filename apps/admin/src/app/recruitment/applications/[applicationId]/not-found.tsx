...
/**
 * No application with that identifier.
 *
 ...
 * not read applications — and neither is the application being absent.
 *
  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-4 p-8">
      <Card className="flex flex-col gap-3 p-6">
        <h1 className="text-lg font-medium">{t('recruitment.label.application')}</h1>
        <p className="text-sm opacity-80">{t('recruitment.label.applicationNotFound')}</p>
