...
/**
 * The web app manifest — what an installed Munaxa Work — Administration looks like on a home screen.
 *
...
export default function manifest(): MetadataRoute.Manifest {
  return brandManifest('work', 'Enterprise HR administration.') as MetadataRoute.Manifest;
}
