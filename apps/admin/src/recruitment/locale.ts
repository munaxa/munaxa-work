import ar from '@work/recruitment/locales/ar.json';
import en from '@work/recruitment/locales/en.json';

/**
 * The recruitment screens' text, in both first-class languages.
 *
 ...
 *
 * A *code* is never translated here. A source, a reason and an interview mode are tenant or
 * country-pack values (00B), so the screen renders what the customer stored rather than looking it
 * up in a list this product ships — the same reason the domain refuses to interpret them.
 */
