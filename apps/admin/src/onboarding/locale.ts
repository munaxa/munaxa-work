import ar from '@work/onboarding/locales/ar.json';
import en from '@work/onboarding/locales/en.json';

/**
 * The onboarding screens' text, in both first-class languages.
 *
 ...
 *
 * A *code* is never translated here. A plan code, a role queue, a waiver reason and a document type
 ...
 * choice and survives review, whereas `onboarding.label.joiners` on the screen is unmistakably a
